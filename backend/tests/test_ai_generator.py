...
class TestAIGeneratorToolCalling:
    ...
    def test_generate_response_calls_tool_when_needed(self, mock_anthropic):
        ...
        mock_tool_manager.execute_tool.return_value = "Search results: ML basics content"
    ...
    def test_tool_results_passed_to_follow_up(self, mock_anthropic):
        ...
        assert tool_result_message["content"][0]["content"] == "Python course content here"
...
class TestMultiRoundToolCalling:
    ...
    def test_two_sequential_tool_calls(self, mock_anthropic):
        ...
        final_response = MockResponse(
            content=[MockContentBlock("text", text="Based on both searches, the answer is...")],
            stop_reason="end_turn"
        )
        ...
        mock_tool_manager = Mock()
        mock_tool_manager.execute_tool.side_effect = ["Course outline here", "Lesson content here"]
